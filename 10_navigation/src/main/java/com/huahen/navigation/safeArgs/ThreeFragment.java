...
public class ThreeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Bundle bundle = new ThreeFragmentArgs.Builder().setStr("I am str come form ThreeFragment").setIntText(Integer.parseInt("0315")).build().toBundle();
        mView.findViewById(R.id.btn_jump_fourFragment).setOnClickListener(Navigation.createNavigateOnClickListener(R.id.action_threeFragment_to_fourFragment,bundle));
